 ...
 */
public class HomePriceAdapter extends RecyclerView.Adapter<HomePriceAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.item_homeprice, null));
    }
